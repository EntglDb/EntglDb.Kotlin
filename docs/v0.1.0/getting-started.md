---
layout: default
title: Getting Started v0.1.0
---

# Getting Started with EntglDb Kotlin (v0.1.0-alpha)
...
dependencies {
    ...
    implementation("com.entgldb:core:0.1.0-alpha")
    
    // Networking support (Recommended for sync)
    implementation("com.entgldb:network:0.1.0-alpha")
    
    // SQLite storage (Recommended for persistence)
    implementation("com.entgldb:persistence-sqlite:0.1.0-alpha")
}
```
